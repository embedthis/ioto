...
$(BUILD)/bin/db: $(DEPS_46)
	...
	$(CC) -o $(BUILD)/bin/db $(LIBPATHS)   "$(BUILD)/obj/db.o" -lcrypto  $(LIBPATHS_46) $(LIBS_46) $(LIBS_46)
endif
...
$(BUILD)/bin/ioto: $(DEPS_52)
	...
	$(CC) -o $(BUILD)/bin/ioto $(LIBPATHS)   "$(BUILD)/obj/main.o" -lapp -lapp -lapp -lapp  $(LIBPATHS_52) $(LIBS_52) $(LIBS_52)
endif
...
$(BUILD)/bin/json: $(DEPS_53)
	...
	$(CC) -o $(BUILD)/bin/json $(LIBPATHS)   "$(BUILD)/obj/json.o" -lcrypto  $(LIBPATHS_53) $(LIBS_53) $(LIBS_53)
endif
...
$(BUILD)/bin/password: $(DEPS_54)
	...
	$(CC) -o $(BUILD)/bin/password $(LIBPATHS)   "$(BUILD)/obj/password.o" -lcrypto  $(LIBPATHS_54) $(LIBS_54) $(LIBS_54)
...
$(BUILD)/bin/webserver: $(DEPS_55)
	...
	$(CC) -o $(BUILD)/bin/webserver $(LIBPATHS)   "$(BUILD)/obj/web.o" -lcrypto  $(LIBPATHS_55) $(LIBS_55) $(LIBS_55)
