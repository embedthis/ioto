#
#   ioto-freertos-default.mk -- Makefile to build Ioto for freertos
#
...
ME_CONFIGURE          ?= \"me -d -q -platform freertos-arm-default -configure . --with mbedtls -gen make\"
ME_CONFIGURED         ?= 1
ME_DEBUG              ?= 1
ME_DEPTH              ?= 1
...
prep:
	...
	@[ ! -f $(BUILD)/inc/me.h ] && cp projects/ioto-freertos-$(PROFILE)-me.h $(BUILD)/inc/me.h ; true
	@if ! diff $(BUILD)/inc/me.h projects/ioto-freertos-$(PROFILE)-me.h >/dev/null ; then\
		cp projects/ioto-freertos-$(PROFILE)-me.h $(BUILD)/inc/me.h  ; \
	fi; true
...
$(BUILD)/obj/openaiLib.o: \
	...
	$(CC) -c -o $(BUILD)/obj/openaiLib.o $(CFLAGS) $(DFLAGS) -DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" lib/openaiLib.c
...
$(BUILD)/obj/password.o: \
	...
	$(CC) -c -o $(BUILD)/obj/password.o $(CFLAGS) $(DFLAGS) -DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" cmds/password.c
...
$(BUILD)/obj/rLib.o: \
	...
	$(CC) -c -o $(BUILD)/obj/rLib.o $(CFLAGS) $(DFLAGS) -DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" lib/rLib.c
...
$(BUILD)/obj/start.o: \
	...
	$(CC) -c -o $(BUILD)/obj/start.o $(CFLAGS) $(DFLAGS) -DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" cmds/start.c
...
$(BUILD)/obj/uctxAssembly.o: \
	...
	$(CC) -c -o $(BUILD)/obj/uctxAssembly.o $(CFLAGS) $(DFLAGS) -DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" lib/uctxAssembly.S
...
$(BUILD)/obj/uctxLib.o: \
	...
	$(CC) -c -o $(BUILD)/obj/uctxLib.o $(CFLAGS) $(DFLAGS) -DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" lib/uctxLib.c
...
$(BUILD)/obj/urlLib.o: \
	...
	$(CC) -c -o $(BUILD)/obj/urlLib.o $(CFLAGS) $(DFLAGS) -DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" lib/urlLib.c
...
$(BUILD)/obj/web.o: \
	...
	$(CC) -c -o $(BUILD)/obj/web.o $(CFLAGS) $(DFLAGS) -DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" cmds/web.c
...
$(BUILD)/obj/webLib.o: \
	...
	$(CC) -c -o $(BUILD)/obj/webLib.o $(CFLAGS) $(DFLAGS) -DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" lib/webLib.c
...
$(BUILD)/obj/websocketsLib.o: \
	...
	$(CC) -c -o $(BUILD)/obj/websocketsLib.o $(CFLAGS) $(DFLAGS) -DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" lib/websocketsLib.c
...
$(BUILD)/bin/db: $(DEPS_36)
	...
	$(CC) -o $(BUILD)/bin/db $(LIBPATHS)   "$(BUILD)/obj/db.o" -lcrypto  $(LIBPATHS_36) $(LIBS_36) $(LIBS_36)
endif
...
$(BUILD)/bin/ioto: $(DEPS_37)
	...
	$(CC) -o $(BUILD)/bin/ioto $(LIBPATHS)   "$(BUILD)/obj/main.o" "$(BUILD)/obj/start.o" -lcrypto  $(LIBPATHS_37) $(LIBS_37) $(LIBS_37)
endif
...
$(BUILD)/bin/json: $(DEPS_38)
	...
	$(CC) -o $(BUILD)/bin/json $(LIBPATHS)   "$(BUILD)/obj/json.o" -lcrypto  $(LIBPATHS_38) $(LIBS_38) $(LIBS_38)
endif
...
$(BUILD)/bin/password: $(DEPS_39)
	...
	$(CC) -o $(BUILD)/bin/password $(LIBPATHS)   "$(BUILD)/obj/password.o" -lcrypto  $(LIBPATHS_39) $(LIBS_39) $(LIBS_39)
...
$(BUILD)/bin/webserver: $(DEPS_40)
	...
	$(CC) -o $(BUILD)/bin/webserver $(LIBPATHS)   "$(BUILD)/obj/web.o" -lcrypto  $(LIBPATHS_40) $(LIBS_40) $(LIBS_40)
