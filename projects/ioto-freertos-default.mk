...
$(BUILD)/obj/webserver.o: \
	...
	$(CC) -c -o $(BUILD)/obj/webserver.o $(CFLAGS) $(DFLAGS) -DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" cmds/webserver.c
...
$(BUILD)/bin/db: $(DEPS_32)
	...
	$(CC) -o $(BUILD)/bin/db $(LIBPATHS)   "$(BUILD)/obj/db.o" -lcrypto  $(LIBPATHS_32) $(LIBS_32) $(LIBS_32)
endif
...
$(BUILD)/bin/ioto: $(DEPS_33)
	...
	$(CC) -o $(BUILD)/bin/ioto $(LIBPATHS)   "$(BUILD)/obj/main.o" "$(BUILD)/obj/start.o" -lcrypto  $(LIBPATHS_33) $(LIBS_33) $(LIBS_33)
endif
...
$(BUILD)/bin/json: $(DEPS_34)
	...
	$(CC) -o $(BUILD)/bin/json $(LIBPATHS)   "$(BUILD)/obj/json.o" -lcrypto  $(LIBPATHS_34) $(LIBS_34) $(LIBS_34)
endif
...
$(BUILD)/bin/password: $(DEPS_35)
	...
	$(CC) -o $(BUILD)/bin/password $(LIBPATHS)   "$(BUILD)/obj/password.o" -lcrypto  $(LIBPATHS_35) $(LIBS_35) $(LIBS_35)
...
$(BUILD)/bin/webserver: $(DEPS_36)
	...
	$(CC) -o $(BUILD)/bin/webserver $(LIBPATHS)   "$(BUILD)/obj/webserver.o" -lcrypto  $(LIBPATHS_36) $(LIBS_36) $(LIBS_36)
