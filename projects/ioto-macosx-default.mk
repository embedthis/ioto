...
$(BUILD)/obj/webserver.o: \
	...
	$(CC) -c -o $(BUILD)/obj/webserver.o -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) -DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH) -DME_COM_MBEDTLS_PATH=$(ME_COM_MBEDTLS_PATH) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" "-I$(ME_COM_MBEDTLS_PATH)/include" cmds/webserver.c
...
$(BUILD)/bin/db: $(DEPS_32)
	...
	$(CC) -o $(BUILD)/bin/db -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)     "$(BUILD)/obj/db.o" $(LIBPATHS_32) $(LIBS_32) $(LIBS_32) $(LIBS) 
endif
...
$(BUILD)/bin/ioto: $(DEPS_33)
	...
	$(CC) -o $(BUILD)/bin/ioto -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)     "$(BUILD)/obj/main.o" "$(BUILD)/obj/start.o" $(LIBPATHS_33) $(LIBS_33) $(LIBS_33) $(LIBS) 
endif
...
ifeq ($(ME_COM_MBEDTLS),1)
    LIBS_34 += -lmbedtls
    LIBPATHS_34 += -L"$(ME_COM_MBEDTLS_PATH)/lib"
    LIBPATHS_34 += -L"$(ME_COM_MBEDTLS_PATH)/library"
endif
endif
ifeq ($(ME_COM_MBEDTLS),1)
    LIBS_34 += -lmbedcrypto
...
$(BUILD)/bin/json: $(DEPS_34)
	...
	$(CC) -o $(BUILD)/bin/json -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)     "$(BUILD)/obj/json.o" $(LIBPATHS_34) $(LIBS_34) $(LIBS_34) $(LIBS) 
endif
...
ifeq ($(ME_COM_MBEDTLS),1)
    LIBS_35 += -lmbedtls
    LIBPATHS_35 += -L"$(ME_COM_MBEDTLS_PATH)/lib"
    LIBPATHS_35 += -L"$(ME_COM_MBEDTLS_PATH)/library"
endif
endif
ifeq ($(ME_COM_MBEDTLS),1)
    LIBS_35 += -lmbedcrypto
...
$(BUILD)/bin/password: $(DEPS_35)
	...
	$(CC) -o $(BUILD)/bin/password -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)     "$(BUILD)/obj/password.o" $(LIBPATHS_35) $(LIBS_35) $(LIBS_35) $(LIBS) 
...
$(BUILD)/bin/webserver: $(DEPS_36)
	...
	$(CC) -o $(BUILD)/bin/webserver -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)     "$(BUILD)/obj/webserver.o" $(LIBPATHS_36) $(LIBS_36) $(LIBS_36) $(LIBS) 
