...
$(BUILD)/obj/agent.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/agent.o" -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) "-DAPP=$(APP)" "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" "-DME_COM_MBEDTLS_PATH=$(ME_COM_MBEDTLS_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" "-I$(ME_COM_MBEDTLS_PATH)/include" $(INPUT) "src/agent.c"
...
$(BUILD)/obj/ai.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/ai.o" -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) "-DAPP=$(APP)" "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" "-DME_COM_MBEDTLS_PATH=$(ME_COM_MBEDTLS_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" "-I$(ME_COM_MBEDTLS_PATH)/include" $(INPUT) "src/ai.c"
...
$(BUILD)/obj/app.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/app.o" -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) "-DAPP=$(APP)" "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" "-DME_COM_MBEDTLS_PATH=$(ME_COM_MBEDTLS_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" "-I$(ME_COM_MBEDTLS_PATH)/include" $(INPUT) "src/app.c"
...
$(BUILD)/obj/cloud.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/cloud.o" -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) "-DAPP=$(APP)" "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" "-DME_COM_MBEDTLS_PATH=$(ME_COM_MBEDTLS_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" "-I$(ME_COM_MBEDTLS_PATH)/include" $(INPUT) "src/cloud/cloud.c"
...
$(BUILD)/obj/cloudwatch.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/cloudwatch.o" -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) "-DAPP=$(APP)" "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" "-DME_COM_MBEDTLS_PATH=$(ME_COM_MBEDTLS_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" "-I$(ME_COM_MBEDTLS_PATH)/include" $(INPUT) "src/cloud/cloudwatch.c"
...
$(BUILD)/obj/config.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/config.o" -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) "-DAPP=$(APP)" "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" "-DME_COM_MBEDTLS_PATH=$(ME_COM_MBEDTLS_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" "-I$(ME_COM_MBEDTLS_PATH)/include" $(INPUT) "src/config.c"
...
$(BUILD)/obj/cron.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/cron.o" -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) "-DAPP=$(APP)" "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" "-DME_COM_MBEDTLS_PATH=$(ME_COM_MBEDTLS_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" "-I$(ME_COM_MBEDTLS_PATH)/include" $(INPUT) "src/cron.c"
...
$(BUILD)/obj/cryptLib.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/cryptLib.o" -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) "-DAPP=$(APP)" "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" "-DME_COM_MBEDTLS_PATH=$(ME_COM_MBEDTLS_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" "-I$(ME_COM_MBEDTLS_PATH)/include" $(INPUT) "lib/cryptLib.c"
...
$(BUILD)/obj/database.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/database.o" -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) "-DAPP=$(APP)" "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" "-DME_COM_MBEDTLS_PATH=$(ME_COM_MBEDTLS_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" "-I$(ME_COM_MBEDTLS_PATH)/include" $(INPUT) "src/database.c"
...
$(BUILD)/obj/db.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/db.o" -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) "-DAPP=$(APP)" "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" "-DME_COM_MBEDTLS_PATH=$(ME_COM_MBEDTLS_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" "-I$(ME_COM_MBEDTLS_PATH)/include" $(INPUT) "src/cmds/db.c"
...
$(BUILD)/obj/dbLib.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/dbLib.o" -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) "-DAPP=$(APP)" "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" "-DME_COM_MBEDTLS_PATH=$(ME_COM_MBEDTLS_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" "-I$(ME_COM_MBEDTLS_PATH)/include" $(INPUT) "lib/dbLib.c"
...
$(BUILD)/obj/esp32.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/esp32.o" -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) "-DAPP=$(APP)" "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" "-DME_COM_MBEDTLS_PATH=$(ME_COM_MBEDTLS_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" "-I$(ME_COM_MBEDTLS_PATH)/include" $(INPUT) "src/esp32.c"
...
$(BUILD)/obj/helpers.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/helpers.o" -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) "-DAPP=$(APP)" "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" "-DME_COM_MBEDTLS_PATH=$(ME_COM_MBEDTLS_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" "-I$(ME_COM_MBEDTLS_PATH)/include" $(INPUT) "src/cloud/helpers.c"
...
$(BUILD)/obj/ioto.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/ioto.o" -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) "-DAPP=$(APP)" "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" "-DME_COM_MBEDTLS_PATH=$(ME_COM_MBEDTLS_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" "-I$(ME_COM_MBEDTLS_PATH)/include" $(INPUT) "src/cmds/ioto.c"
...
$(BUILD)/obj/json.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/json.o" -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) "-DAPP=$(APP)" "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" "-DME_COM_MBEDTLS_PATH=$(ME_COM_MBEDTLS_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" "-I$(ME_COM_MBEDTLS_PATH)/include" $(INPUT) "src/cmds/json.c"
...
$(BUILD)/obj/jsonLib.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/jsonLib.o" -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) "-DAPP=$(APP)" "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" "-DME_COM_MBEDTLS_PATH=$(ME_COM_MBEDTLS_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" "-I$(ME_COM_MBEDTLS_PATH)/include" $(INPUT) "lib/jsonLib.c"
...
$(BUILD)/obj/logs.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/logs.o" -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) "-DAPP=$(APP)" "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" "-DME_COM_MBEDTLS_PATH=$(ME_COM_MBEDTLS_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" "-I$(ME_COM_MBEDTLS_PATH)/include" $(INPUT) "src/cloud/logs.c"
...
$(BUILD)/obj/mqtt.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/mqtt.o" -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) "-DAPP=$(APP)" "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" "-DME_COM_MBEDTLS_PATH=$(ME_COM_MBEDTLS_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" "-I$(ME_COM_MBEDTLS_PATH)/include" $(INPUT) "src/mqtt.c"
...
$(BUILD)/obj/mqttLib.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/mqttLib.o" -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) "-DAPP=$(APP)" "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" "-DME_COM_MBEDTLS_PATH=$(ME_COM_MBEDTLS_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" "-I$(ME_COM_MBEDTLS_PATH)/include" $(INPUT) "lib/mqttLib.c"
...
$(BUILD)/obj/openaiLib.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/openaiLib.o" -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) "-DAPP=$(APP)" "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" "-DME_COM_MBEDTLS_PATH=$(ME_COM_MBEDTLS_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" "-I$(ME_COM_MBEDTLS_PATH)/include" $(INPUT) "lib/openaiLib.c"
...
$(BUILD)/obj/password.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/password.o" -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) "-DAPP=$(APP)" "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" "-DME_COM_MBEDTLS_PATH=$(ME_COM_MBEDTLS_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" "-I$(ME_COM_MBEDTLS_PATH)/include" $(INPUT) "src/cmds/password.c"
...
$(BUILD)/obj/provision.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/provision.o" -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) "-DAPP=$(APP)" "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" "-DME_COM_MBEDTLS_PATH=$(ME_COM_MBEDTLS_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" "-I$(ME_COM_MBEDTLS_PATH)/include" $(INPUT) "src/cloud/provision.c"
...
$(BUILD)/obj/rLib.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/rLib.o" -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) "-DAPP=$(APP)" "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" "-DME_COM_MBEDTLS_PATH=$(ME_COM_MBEDTLS_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" "-I$(ME_COM_MBEDTLS_PATH)/include" $(INPUT) "lib/rLib.c"
...
$(BUILD)/obj/register.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/register.o" -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) "-DAPP=$(APP)" "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" "-DME_COM_MBEDTLS_PATH=$(ME_COM_MBEDTLS_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" "-I$(ME_COM_MBEDTLS_PATH)/include" $(INPUT) "src/register.c"
...
$(BUILD)/obj/serialize.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/serialize.o" -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) "-DAPP=$(APP)" "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" "-DME_COM_MBEDTLS_PATH=$(ME_COM_MBEDTLS_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" "-I$(ME_COM_MBEDTLS_PATH)/include" $(INPUT) "src/serialize.c"
...
$(BUILD)/obj/setup.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/setup.o" -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) "-DAPP=$(APP)" "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" "-DME_COM_MBEDTLS_PATH=$(ME_COM_MBEDTLS_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" "-I$(ME_COM_MBEDTLS_PATH)/include" $(INPUT) "src/setup.c"
...
$(BUILD)/obj/shadow.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/shadow.o" -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) "-DAPP=$(APP)" "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" "-DME_COM_MBEDTLS_PATH=$(ME_COM_MBEDTLS_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" "-I$(ME_COM_MBEDTLS_PATH)/include" $(INPUT) "src/cloud/shadow.c"
...
$(BUILD)/obj/sync.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/sync.o" -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) "-DAPP=$(APP)" "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" "-DME_COM_MBEDTLS_PATH=$(ME_COM_MBEDTLS_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" "-I$(ME_COM_MBEDTLS_PATH)/include" $(INPUT) "src/cloud/sync.c"
...
$(BUILD)/obj/uctxAssembly.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/uctxAssembly.o" -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) "-DAPP=$(APP)" "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" "-DME_COM_MBEDTLS_PATH=$(ME_COM_MBEDTLS_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" "-I$(ME_COM_MBEDTLS_PATH)/include" $(INPUT) "lib/uctxAssembly.S"
...
$(BUILD)/obj/uctxLib.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/uctxLib.o" -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) "-DAPP=$(APP)" "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" "-DME_COM_MBEDTLS_PATH=$(ME_COM_MBEDTLS_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" "-I$(ME_COM_MBEDTLS_PATH)/include" $(INPUT) "lib/uctxLib.c"
...
$(BUILD)/obj/update.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/update.o" -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) "-DAPP=$(APP)" "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" "-DME_COM_MBEDTLS_PATH=$(ME_COM_MBEDTLS_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" "-I$(ME_COM_MBEDTLS_PATH)/include" $(INPUT) "src/cloud/update.c"
...
$(BUILD)/obj/url.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/url.o" -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) "-DAPP=$(APP)" "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" "-DME_COM_MBEDTLS_PATH=$(ME_COM_MBEDTLS_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" "-I$(ME_COM_MBEDTLS_PATH)/include" $(INPUT) "src/cmds/url.c"
...
$(BUILD)/obj/urlLib.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/urlLib.o" -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) "-DAPP=$(APP)" "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" "-DME_COM_MBEDTLS_PATH=$(ME_COM_MBEDTLS_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" "-I$(ME_COM_MBEDTLS_PATH)/include" $(INPUT) "lib/urlLib.c"
...
$(BUILD)/obj/web.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/web.o" -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) "-DAPP=$(APP)" "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" "-DME_COM_MBEDTLS_PATH=$(ME_COM_MBEDTLS_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" "-I$(ME_COM_MBEDTLS_PATH)/include" $(INPUT) "src/cmds/web.c"
...
$(BUILD)/obj/webLib.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/webLib.o" -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) "-DAPP=$(APP)" "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" "-DME_COM_MBEDTLS_PATH=$(ME_COM_MBEDTLS_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" "-I$(ME_COM_MBEDTLS_PATH)/include" $(INPUT) "lib/webLib.c"
...
$(BUILD)/obj/webserver.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/webserver.o" -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) "-DAPP=$(APP)" "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" "-DME_COM_MBEDTLS_PATH=$(ME_COM_MBEDTLS_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" "-I$(ME_COM_MBEDTLS_PATH)/include" $(INPUT) "src/webserver.c"
...
$(BUILD)/obj/websockLib.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/websockLib.o" -arch $(CC_ARCH) $(CFLAGS) $(DFLAGS) "-DAPP=$(APP)" "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" "-DME_COM_MBEDTLS_PATH=$(ME_COM_MBEDTLS_PATH)" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" "-I$(ME_COM_MBEDTLS_PATH)/include" $(INPUT) "lib/websockLib.c"
...
$(BUILD)/bin/db: $(DEPS_56)
	...
	$(CC) -o "$(BUILD)/bin/db" -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) $(INPUT) "$(BUILD)/obj/db.o" $(LIBPATHS_56) $(LIBS_56) $(LIBS_56) $(LIBS) 
...
ifeq ($(ME_COM_MBEDTLS),1)
    LIBS_57 += -lmbedtls
    LIBPATHS_57 += -L"$(ME_COM_MBEDTLS_PATH)/lib"
...
$(BUILD)/bin/ioto: $(DEPS_57)
	...
	$(CC) -o "$(BUILD)/bin/ioto" -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) $(INPUT) "$(BUILD)/obj/ioto.o" $(LIBPATHS_57) $(LIBS_57) $(LIBS_57) $(LIBS) 
...
$(BUILD)/bin/json: $(DEPS_58)
	...
	$(CC) -o "$(BUILD)/bin/json" -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) $(INPUT) "$(BUILD)/obj/json.o" $(LIBPATHS_58) $(LIBS_58) $(LIBS_58) $(LIBS) 
...
ifeq ($(ME_COM_MBEDTLS),1)
    LIBS_59 += -lmbedtls
    LIBPATHS_59 += -L"$(ME_COM_MBEDTLS_PATH)/lib"
    LIBPATHS_59 += -L"$(ME_COM_MBEDTLS_PATH)/library"
endif
endif
ifeq ($(ME_COM_MBEDTLS),1)
    LIBS_59 += -lmbedcrypto
...
$(BUILD)/bin/password: $(DEPS_59)
	...
	$(CC) -o "$(BUILD)/bin/password" -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) $(INPUT) "$(BUILD)/obj/password.o" $(LIBPATHS_59) $(LIBS_59) $(LIBS_59) $(LIBS) 
...
ifeq ($(ME_COM_MBEDTLS),1)
    LIBS_60 += -lmbedtls
    LIBPATHS_60 += -L"$(ME_COM_MBEDTLS_PATH)/lib"
    LIBPATHS_60 += -L"$(ME_COM_MBEDTLS_PATH)/library"
endif
endif
ifeq ($(ME_COM_MBEDTLS),1)
    LIBS_60 += -lmbedcrypto
...
ifeq ($(ME_COM_MBEDTLS),1)
    LIBS_61 += -lmbedtls
    LIBPATHS_61 += -L"$(ME_COM_MBEDTLS_PATH)/lib"
    LIBPATHS_61 += -L"$(ME_COM_MBEDTLS_PATH)/library"
endif
endif
ifeq ($(ME_COM_MBEDTLS),1)
    LIBS_61 += -lmbedcrypto
