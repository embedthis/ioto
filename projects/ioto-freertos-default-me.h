/*
    me.h -- MakeMe Configure Header for freertos-arm-default
 */
...
/* Prefixes */
    ...
    #define ME_VAPP_PREFIX "/usr/local/lib/ioto/2.7.0"
#endif
    ...
    #define ME_SRC_PREFIX "ioto-2.7.0"
#endif
...
/* Profile */
    ...
    #define ME_CONFIG_CMD "me -d -q -platform freertos-arm-default -configure . --with mbedtls -gen make"
#endif
