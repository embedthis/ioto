...
$(BUILD)/obj/start.o: \
	...
	$(CC) -c -o $(BUILD)/obj/start.o $(CFLAGS) $(DFLAGS) $(IFLAGS) cmds/start.c
...
$(BUILD)/bin/db: $(DEPS_36)
	...
	$(CC) -o $(BUILD)/bin/db $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/db.o" $(LIBPATHS_36) $(LIBS_36) $(LIBS_36) $(LIBS) $(LIBS) 
endif
...
$(BUILD)/bin/ioto: $(DEPS_37)
	...
	$(CC) -o $(BUILD)/bin/ioto $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/main.o" "$(BUILD)/obj/start.o" $(LIBPATHS_37) $(LIBS_37) $(LIBS_37) $(LIBS) $(LIBS) 
endif
...
$(BUILD)/bin/json: $(DEPS_38)
	...
	$(CC) -o $(BUILD)/bin/json $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/json.o" $(LIBPATHS_38) $(LIBS_38) $(LIBS_38) $(LIBS) $(LIBS) 
endif
...
$(BUILD)/bin/password: $(DEPS_39)
	...
	$(CC) -o $(BUILD)/bin/password $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/password.o" $(LIBPATHS_39) $(LIBS_39) $(LIBS_39) $(LIBS) $(LIBS) 
...
$(BUILD)/bin/webserver: $(DEPS_40)
	...
	$(CC) -o $(BUILD)/bin/webserver $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/web.o" $(LIBPATHS_40) $(LIBS_40) $(LIBS_40) $(LIBS) $(LIBS) 
